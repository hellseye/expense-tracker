      ...
      <div className="w-full">
        <div className="relative flex items-center w-full">
          ...
          <input
            type={type}
            className={cn(
              "flex h-11 w-full rounded-xl border border-border bg-surface-200/80 px-4 py-2 text-sm text-foreground placeholder:text-zinc-500 transition-all duration-200 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/30 disabled:opacity-50",
              leftIcon && "pl-10",
              rightIcon && "pr-10",
